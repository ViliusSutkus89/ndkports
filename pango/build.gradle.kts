...
dependencies {
    ...
    implementation("com.viliussutkus89.ndk.thirdparty:fontconfig${ndkVersionSuffix}${dependencyLibraryTypeSuffix}:2.14.2-beta-6")
    ...
    implementation("com.viliussutkus89.ndk.thirdparty:harfbuzz${ndkVersionSuffix}${dependencyLibraryTypeSuffix}:8.3.0-beta-4")
}
